...
if (isMobile || isSmallScreen) {
  ...
  if (lang === "id") {
    ...
    messageText = "Website ini tidak bisa dibuka di perangkat mobile atau tablet. Silakan gunakan komputer (desktop/laptop) untuk pengalaman terbaik.";
  } else {
    messageTitle = "⚠️ Desktop Only";
    messageText = "This website cannot be accessed on mobile or tablet devices. Please use a computer (desktop/laptop) for the best experience.";
  }
